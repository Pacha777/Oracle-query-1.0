...
BEGIN
    DBMS_SCHEDULER.CREATE_JOB (
            job_name => '"PROGRA1"."SAVE_INFORMATION"',
            job_type => 'PLSQL_BLOCK',
            job_action => 'SELECT FULL_NAME FROM PERSON WHERE ID_PERSON IN(SELECT ID_PERSON FROM SIGHTING)',
            number_of_arguments => 0,
            start_date => TO_TIMESTAMP_TZ('2017-10-16 22:48:38.000000000 AMERICA/REGINA','YYYY-MM-DD HH24:MI:SS.FF TZR'),
            repeat_interval => 'FREQ=MINUTELY;INTERVAL=10',
            end_date => TO_TIMESTAMP_TZ('2017-11-30 22:50:01.000000000 AMERICA/REGINA','YYYY-MM-DD HH24:MI:SS.FF TZR'),
            enabled => FALSE,
            auto_drop => FALSE,
            comments => 'SAVE_INFORMATION_IN_TABLE');

         
     
 
    DBMS_SCHEDULER.SET_ATTRIBUTE( 
             name => '"PROGRA1"."SAVE_INFORMATION"', 
